interface SnippetAccessProps {}

export function SnippetAccess({}: SnippetAccessProps) {
  return (
    <div className="mockup-code">
      ...
      <pre className="text-code-purple">
        ...
        <code className="text-code-blue-1">
          {`"render Card with href and return Acessar"`}
        </code>
        <code className="text-code-gray">,</code>
        <code className="text-code-gray">()</code>
      ...
      <pre className="ml-code-left-lg">
        <code className="text-code-blue-2">href</code>
        <code className="text-code-red">=</code>
        <code className="text-code-blue-1">{`"/"`}</code>
      </pre>
      <pre className="ml-code-left-lg">
        <code className="text-code-blue-2">isTargetBlank</code>
      </pre>
      <pre className="ml-code-left-md">
        <code className="text-code-gray">{`/>`}</code>
      </pre>
      ...
      <pre className="ml-code-left-sm">
        ...
        <code className="text-code-gray">(</code>
        <code className="text-code-blue-1">{`"Acessar"`}</code>
        <code className="text-code-gray">)</code>
        <code className="text-code-gray">;</code>
      </pre>
      <br />
